...
def main():
    ...
    cds_rows = []
    full_rows = []
    CSV_UTR_IN = "Work\\Outputs\\UTRdb_raw_csv_w_ncbi.csv"
    CSV_CDS_IN = "Work\\Outputs\\records_full_w_stop.csv"
    CSV_OUT = "Work\\Outputs\\paired_UTRdb_CDS_full_only.csv"
    ...
    full_headers = ["ucsc_id","ncbi_id","ensembl_id","common_name","rpkm","cds_start","cds_stop","aa_len","orf_len","nuc_len","fp_len","tp_len","aa_translation","orf_sequence","nuc_sequence", "five_prime", "three_prime"]
